...
cfg <- list(
  ...
  QUAD_COLORS = c(
    "Concordant Up" = "#B2182B", "Concordant Down" = "#2166AC",
    "Discordant" = "#1B7837"
  ),
  QUAD_BG = c(
...
composite_final <- ggdraw(fig) +
  ...
  draw_label(
    "Panel D (NES concordance) uses Hallmark + GO Slim pathways; ORA panels use the full pathway collection.",
