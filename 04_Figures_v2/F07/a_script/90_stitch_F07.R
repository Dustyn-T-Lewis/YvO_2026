...
DAT <- here::here("04_Figures_v2", "F07", "c_data")

message("=== F07: Running main panels + composite + xlsx ===")
source(here::here("04_Figures_v2", "F07", "a_script", "01_main_panels.R"))

message("=== F07: Running supp composite ===")
source(here::here("04_Figures_v2", "F07", "a_script", "02_supp_panels.R"))
