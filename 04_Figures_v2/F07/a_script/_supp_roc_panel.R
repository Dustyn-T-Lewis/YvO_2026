...
stopifnot(
  "pilot ROC data missing: run _supp_prepare_roc.R first" =
...
composite <- composite +
  plot_annotation(
    ...
    caption = paste0(
      ...
      "dashed diagonal = chance. Pilot data: 04_Figures_v2/F07/c_data/classifier_pilot_*.csv."
    ),
    theme = theme(
      plot.title = element_text(
