...
cleanup_after_workbook(f06_specs,
  ...
  extra_files = c(
    f06("03_panel_B_eigengene_data.csv"),
    f06("03_panel_B_triptych_enrichment.csv"),
    f06("04_panel_D_hub_CIs.csv")
  ),
  preserve_patterns = c(
    ...
    "^04_Figures_v2/F06/c_data/mod_bio_labels\\.csv$",
    "^04_Figures_v2/F06/c_data/meta\\.csv$",
    "^04_Figures_v2/F06/c_data/imp_annotations\\.csv$",
    "^04_Figures_v2/F06/c_data/subj_age\\.csv$",
    "^04_Figures_v2/F06/c_data/pheno_wide\\.csv$"
  )
)
