...
composite <- ggdraw(grid) +
  ...
  draw_label(pS_ora_title,
    x = X_LEFT + X_TTL, y = Y_R1,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_ora_subtitle,
    x = X_LEFT + X_TTL, y = Y_R1 - SUB_OFFSET,
  ...
  draw_label(pS_rboot_title,
    x = X_RIGHT + X_TTL, y = Y_R1,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_rboot_subtitle,
    x = X_RIGHT + X_TTL, y = Y_R1 - SUB_OFFSET,
    fontface = "bold.italic", size = CTS$subtitle, colour = "grey30",
    hjust = 0, vjust = 1
  ) +
  ...
  draw_label(pS_circ_title,
    x = X_LEFT + X_TTL, y = Y_R2,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_circ_subtitle,
    x = X_LEFT + X_TTL, y = Y_R2 - SUB_OFFSET,
    fontface = "bold.italic", size = CTS$subtitle, colour = "grey30",
    hjust = 0, vjust = 1
  ) +
  ...
  draw_label(pS_thresh_title,
    x = X_RIGHT + X_TTL, y = Y_R2,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_thresh_subtitle,
    x = X_RIGHT + X_TTL, y = Y_R2 - SUB_OFFSET,
    fontface = "bold.italic", size = CTS$subtitle, colour = "grey30",
    hjust = 0, vjust = 1
  ) +
  ...
  draw_label(pS_goslim_title,
    x = X_LEFT + X_TTL, y = Y_R3,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_goslim_subtitle,
    x = X_LEFT + X_TTL, y = Y_R3 - SUB_OFFSET,
    fontface = "bold.italic", size = CTS$subtitle, colour = "grey30",
    hjust = 0, vjust = 1
  ) +
  ...
  draw_label(pS_lead_title,
    x = X_RIGHT + X_TTL, y = Y_R3,
    fontface = "bold", size = CTS$title, hjust = 0, vjust = 1
  ) +
  draw_label(pS_lead_subtitle,
    x = X_RIGHT + X_TTL, y = Y_R3 - SUB_OFFSET,
    fontface = "bold.italic", size = CTS$subtitle, colour = "grey30",
    hjust = 0, vjust = 1
  )
