...
quad_colors <- c(
  "Reversed Up" = "#E57373", "Reversed Down" = "#64B5F6",
  "Non-reversed" = "grey60"
)
...
pS_goslim <- ggplot(
  ...
  labs(
    title = "GO Slim Category Distribution (Reversal)",
    subtitle = sprintf(
      "DEPs (\u03a0 < 0.05) | %d proteins | %d categories",
      nrow(slim_merged),
