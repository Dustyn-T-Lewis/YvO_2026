...
- `HPA_skeletal_muscle_annotations.tsv`: Human Protein Atlas annotations for the tissue filter. Read by `01_normalize.R` and `F05/a_script/panels/S6_C_compartment.R`.
