...
RPT_SUP <- "04_Figures/F04/b_reports/supp/panels"
...
F04_LABEL_MAP <- c(
  ...
  "Scavenging By Class A Receptors"                    = "Class A Receptor Scavenging",
...
ggsave(file.path(RPT, "MAIN_panel_D_fry.png"), pD_fry,
...
if (!is.null(p_ora_up) || !is.null(p_ora_dn)) {
  ...
  ggsave(file.path(RPT_SUP, "SUPP_panel_D_fry_ora.png"), p_ora,
