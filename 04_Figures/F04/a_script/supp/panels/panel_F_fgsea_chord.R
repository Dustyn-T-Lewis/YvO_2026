# F04 Panel F (SUPP): Merged fGSEA Leading-Edge Chord Diagrams
...
names(dep_membership)[2:5] <- CONTRASTS
...
for (ctr in CONTRASTS) {
  ...
  fbase <- file.path(RPT, paste0("SUPP_panel_F_fgsea_", short))
...
message("\nDone: F04 Panel F fGSEA Leading-Edge Chord Diagrams (SUPP)")
