...
#
# Sources panel scripts and composes from exported ggplot objects.
...
# Source panel scripts — each exports stripped ggplot objects
source("04_Figures/F06/a_script/main/panels/panel_A.R")
source("04_Figures/F06/a_script/main/panels/panel_B_module_nes_scatter.R")
# Exported: pA (heatmap with embedded colorbars), pB (concordance), pC (reversal),
#           p_BC_legend (cowplot ggdraw grob for shared size legend)
...
COMP_W <- 178  # mm (J Physiol single-page width)
COMP_H <- 155  # proportional to 178mm width
