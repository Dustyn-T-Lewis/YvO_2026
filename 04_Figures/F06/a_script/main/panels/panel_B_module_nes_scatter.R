...
ggsave(file.path(RPT_PDF, "MAIN_panel_B_concordance.pdf"), p_left,
       width = PG_W, height = PG_H, units = "mm",
       device = pdf_device, limitsize = FALSE)

ggsave(file.path(RPT_PNG, "MAIN_panel_C_reversal.png"), p_right,
       width = PG_W, height = PG_H, units = "mm",
       dpi = 300, limitsize = FALSE)
ggsave(file.path(RPT_PDF, "MAIN_panel_C_reversal.pdf"), p_right,
       width = PG_W, height = PG_H, units = "mm",
       device = pdf_device, limitsize = FALSE)
...
ggsave(file.path(RPT_PNG, "MAIN_panel_BC_size_legend.png"), p_BC_legend,
       width = 80, height = 18, units = "mm",
       dpi = 300, limitsize = FALSE)
ggsave(file.path(RPT_PDF, "MAIN_panel_BC_size_legend.pdf"), p_BC_legend,
       width = 80, height = 18, units = "mm",
       device = pdf_device, limitsize = FALSE)
