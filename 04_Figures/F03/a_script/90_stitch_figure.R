...
#
# Outputs:
#   b_reports/MAIN_F03_composite.{pdf,png}
...
source("04_Figures/F03/a_script/panels/panel_A_aging.R")           # -> pA
source("04_Figures/F03/a_script/panels/panel_B_training_young.R")  # -> pB
source("04_Figures/F03/a_script/panels/panel_C_training_old.R")    # -> pC
source("04_Figures/F03/a_script/panels/panel_D_interaction.R")     # -> pD
...
BOX_DIR     <- "/Users/dtl0018/Library/CloudStorage/Box-Box/YvO_proteomics_manuscript_2026-04-16/02_Figures/F03_volcanoes"
...
ggsave(file.path(RPT, "MAIN_F03_composite.pdf"), composite,
       width = COMP_W, height = COMP_H, units = "mm", device = pdf_device)
ggsave(file.path(RPT, "MAIN_F03_composite.png"), composite,
       width = COMP_W, height = COMP_H, units = "mm", dpi = 300)
file.copy(file.path(RPT, "MAIN_F03_composite.pdf"), file.path(WRITING_DIR, "01_main_composite_f03.pdf"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F03_composite.png"), file.path(WRITING_DIR, "01_main_composite_f03.png"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F03_composite.png"), file.path(BOX_DIR, "F03_main.png"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F03_composite.pdf"), file.path(BOX_DIR, "pdf", "F03_main.pdf"), overwrite = TRUE)
...
file.copy("04_Figures/F03/c_data/F03_supplementary.xlsx", file.path(WRITING_DIR, "04_supp_data_f03.xlsx"), overwrite = TRUE)
