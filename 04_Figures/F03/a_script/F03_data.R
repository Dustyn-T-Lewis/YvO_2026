#!/usr/bin/env Rscript
# S4 Table: folds the CSVs that F03.R, S4a.R and S4b.R leave in c_data into
# one workbook, then deletes them. Run after those three.
