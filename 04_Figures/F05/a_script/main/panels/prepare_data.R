...
ggsave(file.path(RPT_PNG, "SUPP_melov_reversal_permutation.png"), p_melov,
       width = 180, height = 120, units = "mm", dpi = 300)
ggsave(file.path(RPT_PDF, "SUPP_melov_reversal_permutation.pdf"), p_melov,
       width = 180, height = 120, units = "mm", device = pdf_device)
