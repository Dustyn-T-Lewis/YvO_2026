# Per-module triptych shared by the S8 panels and other_triptychs.R: z-score
# heatmap, eigengene trajectories and top ORA terms. Sourcing it also writes the
# three triptych CSVs in c_data that F05_data.R and the module labels read.
...
RPT_SUPP_PNG <- file.path(BASE, "b_reports", "panels")
RPT_SUPP_PDF <- file.path(BASE, "b_reports", "panels")
