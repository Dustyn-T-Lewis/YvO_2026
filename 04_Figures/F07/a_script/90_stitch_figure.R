...
source("04_Figures/F07/a_script/panels/panel_A.R")                         # MAIN_panel_A_auc.{png,pdf} + panel_A_*.csv
source("04_Figures/F07/a_script/panels/panel_B.R")                         # MAIN_panel_B_hero_grid.png + panel_B_full_screen_bh.csv
...
RPT_PNL <- "04_Figures/F07/b_reports/panels"
WRITING_DIR <- "/Users/dtl0018/Library/CloudStorage/OneDrive-AuburnUniversity/YvO_writing/Figures/F07"
BOX_DIR     <- "/Users/dtl0018/Library/CloudStorage/Box-Box/YvO_proteomics_manuscript_2026-04-16/02_Figures/F07_phenotype_prediction"
...
read_panel <- function(file) {
  path <- file.path(RPT_PNL, file)
  if (!file.exists(path)) stop("Missing: ", path)
  rasterGrob(readPNG(path), interpolate = TRUE)
}

pA_img <- readPNG(file.path(RPT_PNL, "MAIN_panel_A_auc.png"))
pB_img <- readPNG(file.path(RPT_PNL, "MAIN_panel_B_hero_grid.png"))
...
ggsave(file.path(RPT, "MAIN_F07_composite.pdf"), composite_final,
       width = COMP_W, height = COMP_H, units = "mm",
       device = pdf_device, limitsize = FALSE)
ggsave(file.path(RPT, "MAIN_F07_composite.png"), composite_final,
       width = COMP_W, height = COMP_H, units = "mm",
       dpi = 300, limitsize = FALSE)
file.copy(file.path(RPT, "MAIN_F07_composite.pdf"), file.path(WRITING_DIR, "01_main_composite_f07.pdf"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F07_composite.png"), file.path(WRITING_DIR, "01_main_composite_f07.png"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F07_composite.png"), file.path(BOX_DIR, "F07_main.png"), overwrite = TRUE)
file.copy(file.path(RPT, "MAIN_F07_composite.pdf"), file.path(BOX_DIR, "pdf", "F07_main.pdf"), overwrite = TRUE)
...
file.copy(f07("F07_supplementary.xlsx"), file.path(WRITING_DIR, "04_supp_data_f07.xlsx"), overwrite = TRUE)
file.copy(f07("F07_supplementary.xlsx"), file.path(BOX_DIR, "F07_source_data.xlsx"), overwrite = TRUE)
cleanup_after_workbook(f07_specs,
  extra_subdirs = c("04_Figures/F07/c_data/module_grid"))

# --- Mirror F07 supplementary LOSO panels ---
SUPP_PNL <- "04_Figures/F07/b_reports/supp/panels"
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_sensitivity.pdf"), file.path(WRITING_DIR, "05_supp_loso_sensitivity_f07.pdf"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_sensitivity.png"), file.path(WRITING_DIR, "05_supp_loso_sensitivity_f07.png"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_wgcna_refit.pdf"), file.path(WRITING_DIR, "06_supp_loso_wgcna_refit_f07.pdf"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_wgcna_refit.png"), file.path(WRITING_DIR, "06_supp_loso_wgcna_refit_f07.png"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_sensitivity.png"), file.path(BOX_DIR, "05_supp_loso_sensitivity_f07.png"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_sensitivity.pdf"), file.path(BOX_DIR, "pdf", "05_supp_loso_sensitivity_f07.pdf"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_wgcna_refit.png"), file.path(BOX_DIR, "06_supp_loso_wgcna_refit_f07.png"), overwrite = TRUE)
file.copy(file.path(SUPP_PNL, "SUPP_F07_loso_wgcna_refit.pdf"), file.path(BOX_DIR, "pdf", "06_supp_loso_wgcna_refit_f07.pdf"), overwrite = TRUE)
