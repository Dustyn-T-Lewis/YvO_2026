...
# Writes: 04_Figures/F07/b_reports/panels/MAIN_panel_A_auc.png
#
...
W_mm <- 480; H_mm <- 200
ggsave(file.path(RPT, "MAIN_panel_A_auc.png"), composite,
       width = W_mm, height = H_mm, units = "mm", dpi = 300)
ggsave(file.path(RPT, "MAIN_panel_A_auc.pdf"), composite,
       width = W_mm, height = H_mm, units = "mm")

message("Wrote: ", file.path(RPT, "MAIN_panel_A_auc.{png,pdf}"))
