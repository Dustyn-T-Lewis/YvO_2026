...
# are, where the fGSEA cache is, and which paths a figure data script must never
...
# Paths a figure data script must never delete when clearing its intermediates.
UPSTREAM_PREFIXES <- c(
  "^00_input/",
  "^01_normalization/",
  "^02_imputation/",
